    ...
    <section className="bg-gray-100 py-16 ">
      ...
      <div className="px-8 py-16">
        <div className="max-w-2xl text-center">
          ...
          <p className="text-gray-700 leading-relaxed">
          At [Your Business Name], our mission is to empower you with the information and tools needed to make secure and informed decisions when it comes to real estate investments. We believe in transparency, integrity, and protecting your hard-earned money."
          </p>
